#!/usr/bin/env python3
"""
Script para poblar la base de datos de Vantage.ai con datos de prueba
"""
...
def populate_database():
    ...
    with app.app_context():
        ...
        # Create client users and profiles
        ...
        for service_data in services:
            ...
            service = Service(
                ...
                modality=service_data["category"],
        ...
        quote_requests = [
            {
                "item_name": "Bomba Centrífuga Multietapa X-5000",
                "item_type": "producto",
                "quantity": 2,
                ...
                "client_email": "cliente1@mineraandes.cl",
                "provider_email": "juan.perez@solucioneshidraulicas.cl"
            },
            {
                "item_name": "Mantenimiento Preventivo de Bombas",
                "item_type": "servicio",
                "quantity": 1,
            ...
            {
                "item_name": "Casco de Seguridad Minero con Barbiquejo",
                "item_type": "producto",
                "quantity": 50,
                "message": "Cotización para 50 cascos de seguridad minero con barbiquejo. Requiero certificación ANSI y entrega en 2 semanas.",
                "client_email": "cliente2@mineraoriente.cl",
                "provider_email": "carlos.rodriguez@seguridadtotal.cl"
            },
            {
                "item_name": "Capacitación en Seguridad Industrial",
                "item_type": "servicio",
                "quantity": 1,
        ...
        for quote_data in quote_requests:
            ...
            client_user = User.query.filter_by(email=quote_data["client_email"]).first()
            provider_user = User.query.filter_by(email=quote_data["provider_email"]).first()
            provider_profile = ProviderProfile.query.filter_by(user_id=provider_user.id).first()
            
            quote_request = QuoteRequest(
                client_user_id=client_user.id,
                provider_id=provider_profile.id,
                item_id=1,  # Placeholder
                item_type=quote_data["item_type"],
                item_name_snapshot=quote_data["item_name"],
