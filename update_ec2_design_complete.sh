#!/bin/bash
# Script para actualizar el servidor EC2 con el diseño completo de productos y servicios

echo "🎨 Actualizando servidor EC2 con diseño completo de productos y servicios..."
echo "============================================================"
