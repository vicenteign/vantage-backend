...
export function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  const getMenuItems = () => {
    if (userRole === 'cliente') {
      ...
      // Default to provider routes if role is not detected
      return [
        { 
          href: '/provider/dashboard', 
          label: 'Dashboard', 
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed top-0 left-0 h-full bg-white border-r border-gray-200 shadow-sm z-50 transform transition-transform duration-300 ease-in-out
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">{getPanelTitle()}</p>
              </div>
            </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500 capitalize">
                      {userRole === 'proveedor' ? 'Proveedor' : 'Cliente'}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="p-4 border-t border-gray-200">
            <button
              ...
              className="w-full flex items-center px-3 py-2.5 text-gray-600 hover:bg-red-50 hover:text-red-600 rounded-md transition-all duration-200 group"
            >
